...
f_name_directory = './static/OuputAudios'
# Capture
cap = None
...
def reduceBitRate (input_file,output_file):
   ...
   ffmpeg_path = "C:/Users/harsh/Downloads/ffmpeg-master-latest-win64-gpl/ffmpeg-master-latest-win64-gpl/bin/ffmpeg.exe"
...
def deleteTrashVideos():
    global video
    video_folder = 'D:/Harshitha/The-Online-Exam-Proctor'
